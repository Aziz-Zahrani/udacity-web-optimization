...
var resizePizzas = function(size) {
  ...
  console.log("Time to resize pizzas: " + timeToResize[timeToResize[0].length].duration + "ms");
};
...
function updatePositions() {
  ...
  // moved document.body request outside the for loop to make the browser to query the DOM everyitme the loop Iterates.
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  for (var i = 0, elem; i < PizzaNumber; i++) {
